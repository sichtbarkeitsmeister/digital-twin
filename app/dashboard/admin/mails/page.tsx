            ...
            <div className="grid gap-4 p-4 sm:p-5">
              ...
              <dl className="grid gap-2.5 text-sm">
                {[
                  ...
                  ["User", smtp.user ?? "—"],
                  ["From", smtp.from ?? "—"],
                  ["Passwort", smtp.hasPassword ? `gesetzt (${smtp.passwordLength} Zeichen)` : "fehlt"],
              ...
              {smtp.passwordLooksQuoted ? (
                <div className="flex items-start gap-2 rounded-xl border border-amber-200/80 bg-amber-50 px-3 py-2.5 text-xs text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
                  ...
                  <p>
                    SMTP_PASS scheint in Anführungszeichen zu stehen — in Vercel ohne{" "}
                    <code className="text-[11px]">&quot;</code> speichern, sonst kommt{" "}
