...
-- Agency staff (@sichtbarkeitsmeister.de) become platform admins on signup.
...
-- Platform admins can grant/revoke the platform role (RLS blocks direct updates
-- of other profiles).
...
-- Revoke a pending invite so the email can be invited again.
