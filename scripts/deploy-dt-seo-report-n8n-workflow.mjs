/**
 * Deploy "DT v2 - SEO Report" workflow to n8n Cloud.
 * Usage: node scripts/deploy-dt-seo-report-n8n-workflow.mjs
 */
...
const workflowName = "DT v2 - SEO Report";
...
const codePath = join(root, "scripts/n8n/dt-v2-seo-report-handler.js");
...
function buildConnections() {
  return {
    Webhook: { main: [[{ node: "Run SEO Report", type: "main", index: 0 }]] },
    "Run SEO Report": { main: [[{ node: "Respond", type: "main", index: 0 }]] },
  };
}
